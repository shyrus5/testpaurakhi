...
import 'package:paurakhi/src/core/API/Create%20Grant/create_grant.dart';
import 'package:paurakhi/src/core/themes/appstyles.dart';

void applyGrantBottomSheet(BuildContext context, financeId) {
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text("Apply Now", style: AppStyles.text20PxBold),
                        const SizedBox(height: 20),
                        Row(
                          ...
                          Expanded(
                              child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                      onPressed: () async {
                                        await CreateGrantAPI.createGrant(purposeController.text, context, financeId, valueController.text);
                                      },
    ...
    child: SizedBox(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
            ...
            hintText: 'Estimated Grant Value'),
      ),
    ),
  );
}
